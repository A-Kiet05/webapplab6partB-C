...
public class UserDAO {
    ...
    private static final String DB_USER = "dut";
    ...
    private static final String SQL_SELECT_PASSWORD_BY_ID = 
    ...
    public boolean isCurrentPasswordCorrect(int userId, String rawPassword) throws SQLException {
        String hashedPasswordInDB = null;
        ...
        try (Connection conn = getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    hashedPasswordInDB = rs.getString("password");
                }
            }
        }

        
        if (hashedPasswordInDB != null && !hashedPasswordInDB.isEmpty()) {
            
            return BCrypt.checkpw(rawPassword, hashedPasswordInDB);
        }
    ...
    public boolean updatePassword(int userId, String rawNewPassword) {
        ...
        String newHashedPassword = BCrypt.hashpw(rawNewPassword, BCrypt.gensalt());
