...
/* CSS cho trường input khi có lỗi */
input.input-error,
select.input-error {
    border-color: #dc3545 !important;
    background-color: #fffafa; /* Light red background to highlight */
}
    </style>
</head>
<body>
    ...
    <input type="text" 
           ...
           class="<c:if test="${not empty errorCode}">input-error</c:if>"> <c:if test="${not empty errorCode}">
    ...
    <input type="text" 
           ...
           class="<c:if test="${not empty errorName}">input-error</c:if>"> <c:if test="${not empty errorName}">
    ...
    <input type="email" 
           ...
           class="<c:if test="${not empty errorEmail}">input-error</c:if>"> <c:if test="${not empty errorEmail}">
